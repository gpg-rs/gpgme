...
extern {
    ...
    pub fn gpgme_wait_ext(ctx: gpgme_ctx_t, status: *mut gpgme_error_t, op_err: *mut gpgme_error_t, hang: c_int) -> gpgme_ctx_t;
    ...
    pub fn gpgme_data_new_from_mem(r_dh: *mut gpgme_data_t, buffer: *const c_char, size: size_t, copy: c_int) -> gpgme_error_t;
    pub fn gpgme_data_release_and_get_mem(dh: gpgme_data_t, r_len: *mut size_t) -> *mut c_char;
    pub fn gpgme_free(buffer: *mut c_void);

    pub fn gpgme_data_new_from_cbs(dh: *mut gpgme_data_t, cbs: gpgme_data_cbs_t, handle: *mut c_void) -> gpgme_error_t;
    pub fn gpgme_data_new_from_fd(dh: *mut gpgme_data_t, fd: c_int) -> gpgme_error_t;

    pub fn gpgme_data_new_from_stream(dh: *mut gpgme_data_t, stream: *mut libc::FILE) -> gpgme_error_t;
    ...
    pub fn gpgme_op_encrypt_start(ctx: gpgme_ctx_t, recp: *mut gpgme_key_t, flags: gpgme_encrypt_flags_t, plain: gpgme_data_t, cipher: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_encrypt(ctx: gpgme_ctx_t, recp: *mut gpgme_key_t, flags: gpgme_encrypt_flags_t, plain: gpgme_data_t, cipher: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_encrypt_sign_start(ctx: gpgme_ctx_t, recp: *mut gpgme_key_t, flags: gpgme_encrypt_flags_t, plain: gpgme_data_t, cipher: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_encrypt_sign(ctx: gpgme_ctx_t, recp: *mut gpgme_key_t, flags: gpgme_encrypt_flags_t, plain: gpgme_data_t, cipher: gpgme_data_t) -> gpgme_error_t;

    pub fn gpgme_op_decrypt_result(ctx: gpgme_ctx_t) -> gpgme_decrypt_result_t;
    pub fn gpgme_op_decrypt_start(ctx: gpgme_ctx_t, cipher: gpgme_data_t, plain: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_decrypt(ctx: gpgme_ctx_t, cipher: gpgme_data_t, plain: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_decrypt_verify_start(ctx: gpgme_ctx_t, cipher: gpgme_data_t, plain: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_decrypt_verify(ctx: gpgme_ctx_t, cipher: gpgme_data_t, plain: gpgme_data_t) -> gpgme_error_t;

    pub fn gpgme_op_sign_result(ctx: gpgme_ctx_t) -> gpgme_sign_result_t;
    pub fn gpgme_op_sign_start(ctx: gpgme_ctx_t, plain: gpgme_data_t, sig: gpgme_data_t, mode: gpgme_sig_mode_t) -> gpgme_error_t;
    pub fn gpgme_op_sign(ctx: gpgme_ctx_t, plain: gpgme_data_t, sig: gpgme_data_t, mode: gpgme_sig_mode_t) -> gpgme_error_t;

    pub fn gpgme_op_verify_result(ctx: gpgme_ctx_t) -> gpgme_verify_result_t;
    pub fn gpgme_op_verify_start(ctx: gpgme_ctx_t, sig: gpgme_data_t, signed_text: gpgme_data_t, plaintext: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_verify(ctx: gpgme_ctx_t, sig: gpgme_data_t, signed_text: gpgme_data_t, plaintext: gpgme_data_t) -> gpgme_error_t;
    ...
    pub fn gpgme_op_export_start(ctx: gpgme_ctx_t, pattern: *const c_char, mode: gpgme_export_mode_t, keydata: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_export(ctx: gpgme_ctx_t, pattern: *const c_char, mode: gpgme_export_mode_t, keydata: gpgme_data_t) -> gpgme_error_t;

    pub fn gpgme_op_export_ext_start(ctx: gpgme_ctx_t, pattern: *mut *const c_char, mode: gpgme_export_mode_t, keydata: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_export_ext(ctx: gpgme_ctx_t, pattern: *mut *const c_char, mode: gpgme_export_mode_t, keydata: gpgme_data_t) -> gpgme_error_t;

    pub fn gpgme_op_export_keys_start(ctx: gpgme_ctx_t, keys: *mut gpgme_key_t, mode: gpgme_export_mode_t, keydata: gpgme_data_t) -> gpgme_error_t;
    pub fn gpgme_op_export_keys(ctx: gpgme_ctx_t, keys: *mut gpgme_key_t, mode: gpgme_export_mode_t, keydata: gpgme_data_t) -> gpgme_error_t;
    ...
    pub fn gpgme_op_passwd_start(ctx: gpgme_ctx_t, key: gpgme_key_t, flags: c_uint) -> gpgme_error_t;
    pub fn gpgme_op_passwd(ctx: gpgme_ctx_t, key: gpgme_key_t, flags: c_uint) -> gpgme_error_t;

    pub fn gpgme_op_trustlist_start(ctx: gpgme_ctx_t, pattern: *const c_char, max_level: c_int) -> gpgme_error_t;
    pub fn gpgme_op_trustlist_next(ctx: gpgme_ctx_t, r_item: *mut gpgme_trust_item_t) -> gpgme_error_t;
    ...
    pub fn gpgme_op_getauditlog_start(ctx: gpgme_ctx_t, output: gpgme_data_t, flags: c_uint) -> gpgme_error_t;
    pub fn gpgme_op_getauditlog(ctx: gpgme_ctx_t, output: gpgme_data_t, flags: c_uint) -> gpgme_error_t;

    pub fn gpgme_op_assuan_transact_start(ctx: gpgme_ctx_t, command: *const c_char,
                                          data_cb: gpgme_assuan_data_cb_t, data_cb_value: *mut c_void,
                                          inq_cb: gpgme_assuan_inquire_cb_t, inq_cb_value: *mut c_void,
                                          stat_cb: gpgme_assuan_status_cb_t, stat_cb_value: *mut c_void) -> gpgme_error_t;
    pub fn gpgme_op_assuan_transact_ext(ctx: gpgme_ctx_t, command: *const c_char,
                                        data_cb: gpgme_assuan_data_cb_t, data_cb_value: *mut c_void,
                                        inq_cb: gpgme_assuan_inquire_cb_t, inq_cb_value: *mut c_void,
    ...
    pub fn gpgme_conf_opt_change(opt: gpgme_conf_opt_t, reset: c_int, arg: gpgme_conf_arg_t) -> gpgme_error_t;
